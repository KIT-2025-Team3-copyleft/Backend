...
public record GameProperties(
        ...
        int roundResultDuration, // 라운드 결과 보여주는 시간 (기존 35초)
        int nextRoundDelay,      // 다음 라운드 진입 대기 (기존 5초)
        int voteFailDelay,       // 투표 부결 시 대기 (기존 3초)
        int gameOverCleanupTime, // 게임 종료 후 방 청소 대기 (기존 60초)
